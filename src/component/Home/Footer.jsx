      ...
      <div className=" flex justify-around  ">
        ...
        <div className=" mt-5  ">
          ...
          <ul className="mt-2">
            <li>
              {" "}
              <a href="#">CBSE Class 12 </a>
            </li>
            <li>
              {" "}
              <a href="#">CBSE Class 12th result </a>
            </li>
            <li>
              {" "}
              <a href="#">CBSE Class 12 th syllabus </a>
            </li>
            <li>
              {" "}
              <a href="#"> CBSE Class 12th exam date </a>
            </li>
            <li>
              {" "}
              <a href="#"> CBSE Class 10 </a>
            </li>
            <li>
              {" "}
              <a href="#"> CBSE Class 10th result </a>
            </li>
            <li>
              {" "}
              <a href="#">CBSE Class 10th syllabus</a>
            </li>
          </ul>
        </div>
        {/*fifth column  */}
