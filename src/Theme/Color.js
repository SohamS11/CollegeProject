const Color = {
  dark: {
    ...
    card2: "bg-gray-700", // Dark secondary card background
  ...
  light: {
    ...
    footer: "bg-blue-600 p-5 text-white", // Light footer with white text
    card: "bg-gray-100 text-gray-800", // Light card background with dark text
    card2: "bg-blue-400", // Light secondary card background
