...
const AboutSection = () => {
  ...
  return (
    <div
      className={`bg-${
        darkMode ? "gray-800" : "gradient-to-r from-blue-500 to-gray-200"
      } 
   h-screen py-20 px-10 md:px-20 lg:px-40`}
    >
      <div className="max-w-4xl mx-auto">
        <h2
          className={`text-4xl md:text-5xl lg:text-6xl font-bold text-center mb-10 ${
      ...
      <div className="flex flex-col md:flex-row justify-around items-center mt-16">
        <div
          className={`max-w-md mx-auto mb-10 md:mb-0 rounded-lg shadow-lg overflow-hidden ${
          ...
          <div className="p-8">
            ...
            <div className="flex justify-center items-center mb-8">
              <FontAwesomeIcon
                icon={faBullseye}
                size="3x"
                className={`text-${darkMode ? "gray" : "blue-500"} mr-4`}
              />
              <p className={`text-gray-800 ${darkMode ? "text-white" : ""}`}>
                To empower students with knowledge and skills, cultivate a
                passion get accepted by love
              </p>
            </div>
          </div>
        </div>
        <div
          className={`max-w-md mx-auto mb-10 md:mb-0 bg-white rounded-lg shadow-lg overflow-hidden ${
            darkMode ? Color.dark.card : Color.light.card
          }`}
        >
          <div className="p-8">
